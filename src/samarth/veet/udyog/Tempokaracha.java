 ...
 * @author jatte
 */
public class Tempokaracha extends javax.swing.JFrame {
...
java.sql.Date sqlDate;
    ...
    /**
     * Creates new form Tempokaracha
     */
    public Tempokaracha() throws ClassNotFoundException {
    ...
    public void loadData()
     {
         try
         {
          String sql = "select * from tempoKaracha";
          rs = stmt.executeQuery(sql);
             DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
             model.setRowCount(0);
             while(rs.next())
             {
                 model.addRow(new Object[] {rs.getInt("id"),rs.getString("date"),rs.getInt("Amount"),rs.getString("Resion"),rs.getString("Type"),rs.getInt("trips")});
    ...
    {   dm = (DefaultTableModel) jTable1.getModel();
       ...
       public void loadDate()
     {
         try
         {
          ...
          String sql = "select * from tempoKaracha where date between '"+d+"' and '"+e+"'";
          rs = stmt.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "All", "Payment", "Repair" }));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1050, 50));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 90, -1));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Payment", "Repair" }));
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 280, 180, -1));
        ...
        jPanel2.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 220, 180, 30));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("No.Trips");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 90, -1));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel11_amt1, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 420, 170));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 50, 560, 560));
...
try
{
        ...
        String trips = jTextField5.getText();
        

        
            String sql ="insert into tempoKaracha(date,Resion,trips,amount,type)"
            + "values('"+d+"','"+resion+"','"+trips+"','"+amount+"','"+type+"')";
        ...
        {
            JOptionPane.showMessageDialog(this,"If No of Trips Zero.Put As A Zero");
        }
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        try
        {
            String sql = "delete from tempokaracha where id="+id+"";
            stmt.executeUpdate(sql);
            loadData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tempokaracha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Tempokaracha().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Tempokaracha.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
