 ...
 * @author jatte
 */
public class pondash extends javax.swing.JFrame {
    Connection con;
Statement  stmt;
ResultSet  rs;
...
java.sql.Date sqlDate;
    ...
    /**
     * Creates new form pondash
     */
    public pondash() throws ClassNotFoundException {
        initComponents();
        Connect();
        Createcolum();
        loadData();
    ...
    public void loadData()
     {
         try
         {
          String sql = "select * from pondash";
          rs = stmt.executeQuery(sql);
             DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
             model.setRowCount(0);
             while(rs.next())
             {
                 model.addRow(new Object[] {rs.getInt("id"),rs.getString("date"),rs.getString("vehicle"),rs.getFloat("ton"),rs.getInt("amount")});
    ...
    {   dm = (DefaultTableModel) jTable1.getModel();
       ...
       public void loadDate()
     {
         try
         {
          ...
          String sql = "select * from pondash where date between '"+d+"' and '"+e+"'";
          rs = stmt.executeQuery(sql);
         ...
         public void filter(String query)
    {
           ...
           public void no_brass()
      {
        ...
        {  //float ton = (float) Double.parseDouble(jTextField4.getText());
            sum =  (float) (sum + Double.parseDouble(jTable1.getValueAt( i, 3).toString()));
        }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 10, -1, -1));
        ...
        jPanel4.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 10, -1, 30));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 80, 30));
        ...
        jPanel2.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 180, 30));
        ...
        jPanel2.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, 180, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 50, 660, 520));
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        float ton = (float) Double.parseDouble(jTextField5.getText());
        ...
        try
        {
            String sql ="insert into pondash(date,vehicle,ton,amount)"
            + "values('"+d+"','"+vehicle+"','"+ton+"','"+amt+"')";
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        try
        {
            String sql = "delete from pondash where id="+id+"";
            stmt.executeUpdate(sql);
            loadData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pondash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new pondash().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(pondash.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
