...
java.sql.Date sqlDate;
     ...
     */
    public Workerpayment() throws ClassNotFoundException {
        initComponents();
          Connect();
        Createcolum();
        loadData();
    ...
    public void loadData()
     {
         try
         {
          String sql = "select * from workerpayment";
          rs = stmt.executeQuery(sql);
             DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
             model.setRowCount(0);
             while(rs.next())
             {
                 model.addRow(new Object[] {rs.getInt("id"),rs.getString("date"),rs.getString("type"),rs.getInt("noplates"),rs.getFloat("rpplate"),rs.getInt("amount")});
    ...
    {   dm = (DefaultTableModel) jTable1.getModel();
       ...
       public void loadDate()
     {
         try
         {
          ...
          String sql = "select * from workerpayment where date between '"+d+"' and '"+e+"'";
          rs = stmt.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "All", "4\"", "6\"" }));
        ...
        jPanel4.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 10, -1, 30));
        ...
        jLabel4.setText("Worker Payment");
        ...
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, 180, 30));
        ...
        jLabel7.setText("No Plates");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 90, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Amount");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 90, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 204, 0));
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, 180, 30));

        jComboBox3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "4\"", "6\"" }));
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        int noplates = Integer.parseInt(jTextField4.getText());
        Double rpp = Double.parseDouble(jTextField2.getText());
        int amt = (int) (noplates*rpp);
        jLabel1.setText(amt+"");

        try
        {
            String sql ="insert into workerpayment(noplates,rpplate,date,type,amount)"
            + "values('"+noplates+"','"+rpp+"','"+d+"','"+type+"','"+amt+"')";
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        try
        {
            String sql = "delete from workerpayment where id="+id+"";
            stmt.executeUpdate(sql);
            loadData();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(Workerpayment.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
