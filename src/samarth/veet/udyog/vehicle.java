...
DefaultTableModel dm;
     ...
     */
    public vehicle() throws ClassNotFoundException {
        initComponents();
     ...
     public void loadData()
     {
         try
         {
          ...
          rs = stmt.executeQuery(sql);
             ...
             while(rs.next())
             {
                 model.addRow(new Object[] {rs.getInt("vid"),rs.getString("vname")});
    ...
    private void initComponents() {
        ...
        jPanel3.add(side_panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 130, 610));
        ...
        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, 880, 50));
        ...
        jLabel4.setText("Create New Vehicle");
        ...
        jLabel2.setText("Enter Vehicle No");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 150, -1));
        ...
        jPanel1.add(button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 140, 40));

        jPanel3.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 400, 310));
        ...
        button2.setLabel("Delete Vehicle");
        ...
        jPanel3.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 360, 400, 170));
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 50, 480, 480));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 530));
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try
        {
            String sql ="insert into vehicle(vname)"
            + "values('"+na+"')";
        ...
        {
            JOptionPane.showMessageDialog(this, "Enter Vehicle No");
        }
        loadData();
