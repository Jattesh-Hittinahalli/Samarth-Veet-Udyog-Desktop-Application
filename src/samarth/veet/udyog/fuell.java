 ...
 * @author jatte
 */
public class fuell extends javax.swing.JFrame {
     Connection con;
Statement  stmt;
ResultSet  rs;
...
java.sql.Date sqlDate;
    ...
    public void loadData()
     {
         try
         {
          String sql = "select * from fuel";
             ...
             runnable = new Runnable() {
                 ...
                 public void run() {
                     try {
                         ...
                         Logger.getLogger(fuell.class.getName()).log(Level.SEVERE, null, ex);
                     }
                 }
             };
             ...
             while(rs.next())
             {
                 model.addRow(new Object[] {rs.getInt("id"),rs.getString("date"),rs.getInt("Amount"),rs.getString("No.Liter")});
    ...
    {   dm = (DefaultTableModel) jTable1.getModel();
       ...
       public void loadDate()
     {
         try
         {
          ...
          String sql = "select * from diesel where date between '"+d+"' and '"+e+"'";
          rs = stmt.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        jPanel2.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 180, 30));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Amount");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 90, -1));
        ...
        jPanel2.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 180, 30));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("No.liter");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 90, -1));
        ...
        jPanel2.add(button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 120, 50));
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try
        {
            ...
            String noliter = jTextField5.getText();

            String sql ="insert into diesel(date,liter,amount)"
            + "values('"+d+"','"+noliter+"','"+amount+"')";
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        try
        {
            String sql = "delete from diesel where id="+id+"";
            stmt.executeUpdate(sql);
            loadData();
